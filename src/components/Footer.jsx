      ...
      <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-md">
          ...
          <form class="mt-6">
            <div class="relative max-w-lg">
              ...
              <button class="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-purple-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700">
                Subscribe
              </button>
            </div>
          </form>
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div class="mx-auto max-w-sm lg:max-w-none">
            <h1 className="text-purple-600 text-2xl font-bold">CozyStay</h1>
            <p class="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
              We inspire and reach millions o travelers <br></br>across 90 local
              websites
            </p>
            ...
            <div class="mt-6 flex justify-center gap-4 lg:justify-start">
              <a
                ...
                rel="noreferrer"
              >
                <span class="sr-only bg-"> Facebook </span>
            ...
            <div>
              ...
              <ul class="mt-6 space-y-1">
                ...
                <li>
                  ...
                  >
                    {" "}
                    856 Cordia Extension<br></br>United State{" "}
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div class="mt-16 border-t border-gray-100 pt-8">
          <p class="text-center text-xs/relaxed text-gray-500 hover:text-gray-700/75">
            © Company 2024. All rights reserved.
            <br />
            his template is made Harshada
          </p>
        </div>
      </div>
    </footer>
